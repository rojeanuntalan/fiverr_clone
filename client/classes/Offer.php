...
class Offer extends Database {
    ...
    public function hasOffer($proposal_id, $user_id) {
        $sql = "SELECT * FROM offers WHERE proposal_id = ? AND user_id = ?";
        $result = $this->executeQuerySingle($sql, [$proposal_id, $user_id]);
